/**
 * MotoCash App v2.5 (Correção Final de Inicialização)
 * Aplicação offline-first para controle financeiro e de manutenção.
 */
document.addEventListener('DOMContentLoaded', () => {
    const App = (() => {
        ...
        // --- 3. MÓDULOS (DEFINIÇÃO COMPLETA ANTES DO USO) ---
